...
with st.expander(
  ...
  st.markdown(
      "**Copy and forward this message to your class or international student"
      " LINE groups:**"
  )
  share_text = (
      "🔥 [Elective Course Recommendation: Python AI Applications]\n"
      "No complex coding syntax required! Learn how to direct AI with natural"
      " language prompts, fetch real-time TSMC & US stock data, and build"
      " mobile Web Apps!\n"
      "• **Language**: English-taught (ideal for international students), with"
      " supplementary Chinese guidance (課程主要以英文講授，並輔以中文說明)。If you"
      " need support for any specific national language, please feel free to"
      " leave a message in the TA section (若有需要增加國家語言，也歡迎在助教區留言)。\n"
      "• **Eligibility**: Open to ALL majors, year levels, and"
      " graduate/undergraduate students across the university—both local and"
      " international students are warmly welcomed!\n"
      "• **Format**: Beginner-friendly with Pair Programming (teams of 1-3)\n"
      "• **Required Gear**: Laptop and Smartphone (A headset with a"
      " microphone is recommended but optional).\n\n"
  ...
  st.caption(
      "💡 Forward this text to your student group chats to invite friends"
      " from any department!"
  )
